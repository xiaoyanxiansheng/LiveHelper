...
Window {
    ...
    function setSearchLiveComboBox(contents){
        searchLiveModel.clear()
        for (let i = 0; i < contents.length; i++) {
            searchLiveModel.append({ "content": contents[i]});
        }
        searchLiveComboBox.currentIndex = contents.length - 1
    }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                MouseArea {
                    ...
                    onPressed: rectangle10.scale = 0.9
                    onReleased: rectangle10.scale = 1
                }
            }
            ...
            Image {
                ...
                MouseArea {
                    ...
                    onPressed: image223.scale = 0.9
                    onReleased: image223.scale = 1
                }
                fillMode: Image.PreserveAspectFit
            }
        ...
        Item {
            ...
            BorderImage {
                ...
                TextField {
                    ...
                    placeholderTextColor: "#b6b8c6"
                    font.family: "Noto Sans S Chinese Medium"
                    selectedTextColor: "#a5a9c8"
                    font.pointSize: 10
                    selectionColor: "#a5a8c3"
                    placeholderText: "请输入直播间名称"
                    background: Rectangle {
                        color: "#eceaff" // 更改为你想要的背景颜色
                        radius: 4
                        border.width: 0
                    }
            ...
            BorderImage {
                    ...
                    MouseArea {
                        ...
                        onClicked:
                        {
                            if (canClick) {
                                canClick = false
                                clickTimer.start()
                                clickEnterLiveByName(searchLiveComboBox.currentText)
                            }
                        }
                ...
                ComboBox {
                    ...
                    font.capitalization: Font.MixedCase
                    background: Rectangle {
                        width: searchLiveComboBox.width
                        height: searchLiveComboBox.height
                        color: "#fafafa"
                        radius: 4
                        border.color: "#ededed"
                        border.width: 1
                        ...
                        MouseArea {
                            anchors.fill: parent
                            onClicked: {
                                searchLiveComboBox.popup.visible = true
                            }
                        }
                    }
                    font.pointSize: 14
                    ...
                    delegate: ItemDelegate {
                        ...
                        onClicked: {
                            searchLiveComboBox.currentIndex = index
                            searchLiveComboBox.popup.visible = false
                        }
                        background: Rectangle {
                            id: bg2
                            color: hovered ? "#eceaff" : "transparent"
                    ...
                    contentItem: TextField {
                        color: "#7a7d94"
                        text: searchLiveComboBox.currentText
                        font.pixelSize: 16
                        background: Rectangle {
                            color: "#00000000"
                            radius: 4
                ...
                Rectangle {
                    ...
                    MouseArea {
                        anchors.fill: parent
                        onReleased: rectangle13.scale = 1
                        onPressed: rectangle13.scale = 0.9
                        onClicked: {
                    ...
                    Image {
                        ...
                        MouseArea {
                            ...
                            onClicked:
                            {
                                ...
                                if(likeTime.text < 1) likeTime.text = 1
                                likeTimeRefresh()
                            }
                            onPressed: parent.scale = 0.9
                            onReleased: parent.scale = 1
            ...
            BorderImage {
                            ...
                            Repeater {
                                ...
                                delegate: FocusScope {
                                    ...
                                    Rectangle {
                                        ...
                                        height: 30
                                        radius: 2
                                        color: helpSelectColumn.helpSelectIndex == index ? "#eceaff" : "#fafafa"
                                        MouseArea {
                                            anchors.fill: parent
                                            onClicked:
                                            {
                                            ...
                                            onPressed: container.scale = 0.9
                                            onReleased: container.scale = 1
                                        }
                ...
                Rectangle {
                    ...
                    ScrollView {
                        ...
                        TextArea {
                            ...
                            font.pixelSize: 14
                            font.bold: true
                            selectionColor: "#b6b8c6"
                            selectedTextColor: "#b6b8c6"
                            font.family: "Noto Sans S Chinese Medium"
                            onTextChanged: {
                ...
                Rectangle {
                    ...
                    MouseArea {
                        anchors.fill: parent
                        onReleased: rectangle11.scale = 1
                        onPressed: rectangle11.scale = 0.9
                        onClicked: {
                            clickSaveHelp()
                        }
                        anchors.bottomMargin: 0
            ...
            BorderImage {
                            ...
                            Repeater {
                                FocusScope {
                                    ...
                                    Rectangle {
                                        ...
                                        MouseArea {
                                            anchors.fill: parent
                                            onPressed: container1.scale = 0.9
                                            onReleased: container1.scale = 1
                                            onClicked: {
                ...
                Rectangle {
                    ...
                    MouseArea {
                        anchors.fill: parent
                        onReleased: rectangle12.scale = 1
                        onPressed: rectangle12.scale = 0.9
                        onClicked: {
                            clickSaveScreen()
                        }
                        anchors.bottomMargin: 0
